...
namespace klib
{
	...
	template <typename _tCell>					void				fillRectangleBorders	(_tCell* target, int32_t targetWidth, int32_t targetHeight, const _tCell& color, const ::gpk::SRectangle2<int32_t>& rect)												{
	...
	template <typename _tCell>					void				fillCircle				(_tCell* target, int32_t targetWidth, int32_t targetHeight, const _tCell& color, const ::gpk::SCircle<int32_t>& circle)												{
	...
	template <typename _tCell, typename _tCoord>	void			fillRectangle			(_tCell* target, int32_t targetWidth, int32_t targetHeight, int32_t targetPitch, const _tCell& color, const ::gpk::SRectangle2<_tCoord>& rect)						{
		const int32_t														ystart					= ::gpk::max(0, ::gpk::min(targetHeight	, rect.Offset.y				));
		const int32_t														xstart					= ::gpk::max(0, ::gpk::min(targetWidth	, rect.Offset.x				));
		const int32_t														ystop					= ::gpk::max(0, ::gpk::min(targetHeight	, rect.Offset.y+rect.Size.y	));
		const int32_t														xstop					= ::gpk::max(0, ::gpk::min(targetWidth	, rect.Offset.x+rect.Size.x	));
	...
	static inline								void				fillRectangle			(_tCell* target, int32_t targetWidth, int32_t targetHeight, int32_t targetPitch, _tCell color, const ::gpk::SRectangle2<_tCoord>& rect, ::klib::ALIGN_SCREEN align)	{
		if(align == (::klib::SCREEN_TOP_LEFT))
			::klib::fillRectangle(target, targetWidth, targetHeight, targetPitch, color, rect);
		else {
			::gpk::SRectangle2<int32_t>										rectAligned				= rect;
	...
	template <typename _tCell, typename _tCoord>	static inline	void		fillRectangle			(_tCell* target, int32_t targetWidth, int32_t targetHeight, _tCell color, const ::gpk::SRectangle2<_tCoord>& rect)								{ ::klib::fillRectangle(target, targetWidth, targetHeight, targetWidth, color, rect);			}
	template <typename _tCell, typename _tCoord>	static inline	void		fillRectangle			(_tCell* target, int32_t targetWidth, int32_t targetHeight, _tCell color, const ::gpk::SRectangle2<_tCoord>& rect, ::klib::ALIGN_SCREEN align)	{ ::klib::fillRectangle(target, targetWidth, targetHeight, targetWidth, color, rect, align);	}
}
