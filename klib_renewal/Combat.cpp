...
::klib::COMBAT_STATUS			klib::applyAttackStatus			(const ::klib::SEntityTables & tables, ::klib::SGameMessages & messages, ::klib::CCharacter& target, COMBAT_STATUS weaponStatus, int32_t absorbChance, int32_t turnCount, const ::gpk::vcc & sourceName)		{
	...
	if((targetFinalFlags.Effect.Defend & ::klib::DEFEND_EFFECT_IMPENETRABLE) && target.Points.LifeCurrent.Shield) {
...
::klib::COMBAT_STATUS		klib::applyAttackStatus			(const ::klib::SEntityTables & tables, ::klib::SGameMessages & messages, ::klib::CCharacter& target, COMBAT_STATUS weaponStatus, int32_t turnCount, const ::gpk::vcc & sourceName) {
	...
	const double					absorptionRatio					= ::gpk::max(0.0, (target.Points.LifeCurrent.Shield/(double)targetArmorShield)) * .5;
...
static	_Check_return_ int64_t				applyWeaponLeech			(::klib::SGameMessages & messages, ::klib::ATTACK_EFFECT testEffectBit, ::klib::ATTACK_EFFECT attackerWeaponEffect, int32_t finalPassthroughDamage, int32_t maxPoints, int64_t currentPoints, const ::gpk::vcc& attackerName, const ::gpk::vcc& targetName, const ::gpk::vcc& attackerWeaponName, const ::gpk::vcc& pointName, const ::gpk::vcc& gainVerb, const ::gpk::vcc& loseVerb ) {
	if(attackerWeaponEffect & testEffectBit) {
		...
		if(actualHPGained > 0)
			sprintf_s(messages.Aux, "%s %s %lli %s from %s with %s.", attackerName.begin(), gainVerb.begin(), actualHPGained, pointName.begin(), targetName.begin(), attackerWeaponName.begin());
		else if(actualHPGained < 0)
			sprintf_s(messages.Aux, "%s %s %lli %s to %s with %s.", attackerName.begin(), loseVerb.begin(),   actualHPGained, pointName.begin(), targetName.begin(), attackerWeaponName.begin());
		messages.LogAuxMessage();
...
static	_Check_return_ ::klib::SLifePoints	applyUnshieldableDamage		(const ::klib::SEntityTables & tables, ::klib::SGameMessages & messages, ::klib::CCharacter& attacker, ::klib::CCharacter& target, const ::klib::SLifePoints& damageDealt) {
	const ::klib::SLifePoints						maxPossibleDamage			=
	...
	const ::klib::SLifePoints						finalDamage =
...
::klib::SLifePoints						klib::applySuccessfulHit			(const ::klib::SEntityTables & tables, ::klib::SGameMessages & messages, ::klib::CCharacter& attacker, ::klib::CCharacter& target, int32_t damage, bool bAddStatus, ::klib::COMBAT_STATUS grenadeStatus, int32_t statusTurns, const ::gpk::vcc& sourceName) {
	...
	if(bAddStatus)
		::klib::applyAttackStatus(tables, messages, target, grenadeStatus, statusTurns, sourceName);
...
void								klib::applyWeaponLeechEffects	(const ::klib::SEntityTables & tables, ::klib::SGameMessages & messages, ::klib::CCharacter& attacker, ::klib::CCharacter& targetReflecting, const SLifePoints& finalDamage, const ::gpk::vcc& sourceName) {
	...
	attacker.Points.LifeCurrent.Mana	= (int32_t)::applyWeaponLeech(messages, ::klib::ATTACK_EFFECT_LEECH_MANA	, attackerFlags.Effect.Attack, finalDamage.Mana		, attackerPoints.LifeMax.Mana	, attacker.Points.LifeCurrent.Mana		, attacker.Name, targetReflecting.Name, sourceName, ::gpk::view_const_string{"Mana"		}, ::gpk::view_const_string{"drains"}, ::gpk::view_const_string{"loses"});
	attacker.Points.LifeCurrent.Shield	= (int32_t)::applyWeaponLeech(messages, ::klib::ATTACK_EFFECT_LEECH_SHIELD	, attackerFlags.Effect.Attack, finalDamage.Shield	, attackerPoints.LifeMax.Shield	, attacker.Points.LifeCurrent.Shield	, attacker.Name, targetReflecting.Name, sourceName, ::gpk::view_const_string{"Shield"	}, ::gpk::view_const_string{"steals"}, ::gpk::view_const_string{"gives"});
	attacker.Points.Coins				= ::applyWeaponLeech(messages, ::klib::ATTACK_EFFECT_STEAL					, attackerFlags.Effect.Attack, finalDamage.Health+finalDamage.Shield+finalDamage.Mana, 0x7FFFFFFF, attacker.Points.Coins	, attacker.Name, targetReflecting.Name, sourceName, ::gpk::view_const_string{"Coins"	}, ::gpk::view_const_string{"steals"}, ::gpk::view_const_string{"drops"});
	attacker			.Recalculate(tables);
...
void								klib::applySuccessfulWeaponHit	(const ::klib::SEntityTables & tables, ::klib::SGameMessages & messages, ::klib::CCharacter& attacker, ::klib::CCharacter& targetReflecting, int32_t damageDealt, const ::gpk::vcc& sourceName) {
	...
	const ::klib::SEntityFlags				& attackerFlags					= attacker.FinalFlags	;
	const ::klib::SLifePoints				finalDamage 					= ::klib::applySuccessfulHit(tables, messages, attacker, targetReflecting, damageDealt, attackerFlags.Status.Inflict != COMBAT_STATUS_NONE, attackerFlags.Status.Inflict, 1, sourceName);

	// Apply combat bonuses from weapon for successful hits.
	const ::klib::SEntityPoints				attackerWeaponPoints			= ::klib::getEntityPoints(tables.Weapon, attacker.CurrentEquip.Weapon);
	::klib::applyCombatBonus(tables, messages, attacker, attackerWeaponPoints, sourceName);

	// Apply weapon effects for successful hits.
	::klib::applyWeaponLeechEffects(tables, messages, attacker, targetReflecting, finalDamage, sourceName);
}

// This function returns the damage dealt to the target
bool								klib::attack					(const ::klib::SEntityTables & tables, ::klib::SGameMessages & messages, ::klib::CCharacter& attacker, ::klib::CCharacter& target) {
	...
	if(true_if(attacker.ActiveBonus.Status.Status & COMBAT_STATUS_BLACKOUT) && (::klib::getEntityFlags(tables.Weapon, attacker.CurrentEquip.Weapon).Tech.Tech & ENTITY_TECHNOLOGY_DIGITAL)) {
	...
	if ((rand() % 100) < finalChance ) {
		...
		::klib::applySuccessfulWeaponHit(tables, messages, attacker, target, damageDealt, attackerWeaponName);
	}
	else {
	...
	if(damageDealt) {
		attacker	.Score.DamageDealt	+= damageDealt; ++attacker	.Score.AttacksHit;
		target		.Score.DamageTaken	+= damageDealt; ++target	.Score.AttacksReceived;
		attacker	.Recalculate(tables);
		target		.Recalculate(tables);
	}
	else  {
...
void								klib::applyCombatBonus		(const ::klib::SEntityTables & tables, ::klib::SGameMessages & messages, ::klib::CCharacter& character, const ::klib::SEntityPoints& combatBonus, const ::gpk::vcc& sourceName) {
	...
	const ::klib::SLifePoints				& lifeMax					= characterPoints.LifeMax;
	::klib::SLifePoints						& lifeCurrent				= character.Points.LifeCurrent;

	int										finalHPAdded				= 0;

	finalHPAdded	= ::gpk::min(combatBonus.LifeCurrent.Health	, ::gpk::max(0, lifeMax.Health	- lifeCurrent.Health));	::applyTurnBonus(tables, messages, character, lifeCurrent.Health, lifeMax.Health, finalHPAdded, character.Name, ::gpk::view_const_string{"Health"}, sourceName);
	finalHPAdded	= ::gpk::min(combatBonus.LifeCurrent.Mana	, ::gpk::max(0, lifeMax.Mana	- lifeCurrent.Mana	));	::applyTurnBonus(tables, messages, character, lifeCurrent.Mana	, lifeMax.Mana	, finalHPAdded, character.Name, ::gpk::view_const_string{"Mana"  }, sourceName);
	finalHPAdded	= ::gpk::min(combatBonus.LifeCurrent.Shield	, ::gpk::max(0, lifeMax.Shield	- lifeCurrent.Shield));	::applyTurnBonus(tables, messages, character, lifeCurrent.Shield, lifeMax.Shield, finalHPAdded, character.Name, ::gpk::view_const_string{"Shield"}, sourceName);
...
static	void				applyPassive					(const ::klib::SEntityTables & tables, ::klib::SGameMessages & messages, ::klib::CCharacter& character, ::klib::PASSIVE_EFFECT equipmentEffects, const ::gpk::vcc& sourceName) {
	...
	::applyRegenBonus(messages, ::klib::PASSIVE_EFFECT_MANA_REGEN		,	equipmentEffects,	characterFinalPoints.LifeMax.Mana	,	character.Points.LifeCurrent.Mana	, ::gpk::view_const_string{"Mana"	}, sourceName);
	::applyRegenBonus(messages, ::klib::PASSIVE_EFFECT_SHIELD_REPAIR	,	equipmentEffects,	characterFinalPoints.LifeMax.Shield	,	character.Points.LifeCurrent.Shield	, ::gpk::view_const_string{"Shield"	}, sourceName);
	character.Recalculate(tables);
}
...
void						klib::applyTurnStatusAndBonusesAndSkipTurn(const ::klib::SEntityTables & tables, ::klib::SGameMessages & messages, ::klib::CCharacter& character) {
	...
	nameAccessory				= ::klib::getEntityName(tables.Accessory	, character.CurrentEquip.Accessory	); ::applyPassive(tables, messages, character, ::klib::getEntityFlags(tables.Accessory	, character.CurrentEquip.Accessory	).Effect.Passive, nameAccessory		); if(0 >= character.Points.LifeCurrent.Health) return;
	//applyPassive		(tables, character, getFlagsVehicle		(tables, character.CurrentEquip.Vehicle		).Effect.Passive, ::klib::getEntityName(tables.Vehicle		, character.CurrentEquip.Vehicle	)); if(0 >= character.Points.LifeCurrent.Health) return;

	character.ActiveBonus.Points.NextTurn(); character.Recalculate(tables);
	character.ActiveBonus.Status.NextTurn(); character.Recalculate(tables);
	//printf("");
}
...
void					klib::applyEnemyTurnStatus(const ::klib::SEntityTables & tables, ::klib::SGameMessages & messages, ::klib::CCharacter& character) {
	...
	for(uint32_t i = 0, statusCount = character.ActiveBonus.Status.MaxStatus; i<statusCount; ++i) {
		...
		switch(statusBit) {
		case COMBAT_STATUS_BLEEDING	:	amount = ::gpk::max(1, finalPoints.LifeMax.Health / 20); if(amount > 0) character.Score.DamageTaken += amount; ::klib::applyShieldableDamage(tables, messages, character, amount, 0, ::gpk::view_const_string{"bleeding" });													; break;
		case COMBAT_STATUS_POISON	:	amount = ::gpk::max(1, finalPoints.LifeMax.Health / 20); if(amount > 0) character.Score.DamageTaken += amount; ::klib::applyShieldableDamage(tables, messages, character, amount, 0, ::gpk::view_const_string{"poisoning"});													; break;
		case COMBAT_STATUS_BURN		:	amount = ::gpk::max(1, finalPoints.LifeMax.Health / 20); if(amount > 0) character.Score.DamageTaken += amount; ::klib::applyShieldableDamage(tables, messages, character, amount, ::klib::getArmorAbsorption(tables.Armor, character.CurrentEquip.Armor), ::gpk::view_const_string{"burning"	});	; break;
		case COMBAT_STATUS_FREEZING	:	amount = ::gpk::max(1, finalPoints.LifeMax.Health / 20); if(amount > 0) character.Score.DamageTaken += amount; ::klib::applyShieldableDamage(tables, messages, character, amount, ::klib::getArmorAbsorption(tables.Armor, character.CurrentEquip.Armor), ::gpk::view_const_string{"freezing"	});	; break;
		case COMBAT_STATUS_SHOCK	:	amount = ::gpk::max(1, finalPoints.LifeMax.Health / 20); if(amount > 0) character.Score.DamageTaken += amount; ::klib::applyShieldableDamage(tables, messages, character, amount, ::klib::getArmorAbsorption(tables.Armor, character.CurrentEquip.Armor), ::gpk::view_const_string{"shocked"	});	; break;
		//case COMBAT_STATUS_STUN	:		break;
		//case COMBAT_STATUS_BLIND	:	break;
		}
	}
...
bool							klib::executeItem			(const ::klib::SEntityTables & tables, ::klib::SGameMessages & messages, int32_t indexInventory, CCharacter& user, CCharacter& target) {
	...
	case ITEM_TYPE_POTION:
		bUsedItem						= ::klib::usePotion(tables, messages, item, user);
		break;
	case ITEM_TYPE_GRENADE:
		bUsedItem						= ::klib::useGrenade(tables, messages, item, user, target);
		break;
	default:
