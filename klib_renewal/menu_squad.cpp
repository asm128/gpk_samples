...
SGameState														drawSquadSetupMenu									(SGame& instanceGame)												{
	...
	int32_t																result												= drawMenu(instanceGame.GlobalDisplay.Screen.View, instanceGame.GlobalDisplay.TextAttributes.begin(), player.Squad.Size, "Squad setup", ::gpk::view_array<const ::klib::SMenuItem<int32_t>>{menuItems}, instanceGame.FrameInput, (int32_t)::gpk::size(player.Squad.Agents), -1, ::gpk::max(24, maxNameLen+4));
