...
namespace klib
{
	stincxp	bool	mouseOver			(::gpk::n2<int32_t> mousePos, ::gpk::n2<int32_t> targetPos, int32_t width)		{ return (mousePos.y == targetPos.y) && (mousePos.x >= targetPos.x) && (mousePos.x < targetPos.x + width); }
...
#pragma pack(pop)
	...
	int32_t				drawMenu				(SDrawMenuState	& localPersistentState, ::gpk::gchar display, uint16_t * targetAttributes, const ::gpk::vcc & title, const ::gpk::view<const ::gpk::vcc> & menuItems, const ::klib::SInput& frameInput, const int32_t noActionValue=-1, uint32_t rowWidth=20, bool disableEscKeyClose=false, const ::gpk::vcc& exitText=::gpk::vcs{"Exit this menu"});
	template <typename _ReturnType>
	const _ReturnType&	drawMenu				(SDrawMenuState	& localPersistentState, ::gpk::gchar display, uint16_t * targetAttributes, const ::gpk::vcc & title, const ::gpk::view<const _ReturnType> & menuItems, const ::gpk::view<const ::gpk::vcc>& menuItemsText, const ::klib::SInput& frameInput, const _ReturnType& exitValue, const _ReturnType& noActionValue=-1, uint32_t rowWidth=20, bool disableEscKeyClose=false, const ::gpk::vcc& exitText=::gpk::vcs{"Exit this menu"}) {
	...
	template <typename _ReturnType>
	const _ReturnType	&									drawMenu						(SDrawMenuState	& localPersistentState, ::gpk::gchar display, uint16_t * targetAttributes, const ::gpk::vcc & title, const ::gpk::view<const ::klib::SMenuItem<_ReturnType>> & menuItems, const ::klib::SInput& frameInput, const _ReturnType& exitValue, const _ReturnType& noActionValue=-1, uint32_t rowWidth=20, bool disableEscKeyClose=false, const ::gpk::vcc& exitText=::gpk::vcs{"Exit this menu"}) {
	...
	struct SMenuHeader {
		...
		constexpr		SMenuHeader				(_ReturnType exitValue, const ::gpk::vcs & title, uint32_t rowWidth=24, bool disableEscapeKey=false, const ::gpk::vcc & exitText = ::gpk::vcs{"Exit this menu"})
			: Title				(title)
			, RowWidth			(rowWidth)
			, ValueExit			(exitValue)
	...
	template <typename _ReturnType>
	const _ReturnType&	drawMenu				(::gpk::gchar & display, uint16_t * targetAttributes, SMenuHeader<_ReturnType> & menuInstance, const ::gpk::view<const ::klib::SMenuItem<_ReturnType>> & menuItems, const ::klib::SInput& frameInput, _ReturnType noActionValue = -1) {
