...
#include "klib_ascii_color.h"
	...
	::gpk::drawRectangle(console.Characters	, character	, ::gpk::SRectangle2<uint32_t>{{}, console.Characters	.metrics()});
	::gpk::drawRectangle(console.Colors		, color		, ::gpk::SRectangle2<uint32_t>{{}, console.Colors		.metrics()});
	return 0;
}
