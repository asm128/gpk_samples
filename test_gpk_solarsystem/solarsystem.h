...
namespace ssg 
{
	...
	struct SScene {
		::gpk::array_pod<::ssg::SModelPivot>					Pivot							= {};
...
#pragma pack(pop)
	...
	struct SSolarSystem {
		::gpk::array_obj<::ssg::SStar>							NamesStars						= {};
		::gpk::array_obj<::ssg::SPlanet>						NamesPlanets					= {};
		::gpk::array_pod<::ssg::SStarDetail>					DetailStars						= {};
		::gpk::array_pod<::ssg::SPlanetDetail>					DetailPlanets					= {};
		::gpk::array_pod<::ssg::SStellarBody>					StellarBodies					= {};
	...
	::gpk::error_t											solarSystemUpdate				(::ssg::SSolarSystemGame & sunsystem, double secondsLastFrame, ::gpk::ptr_obj<::gpk::SRenderTarget<::gpk::SColorBGRA, uint32_t>> & target);
